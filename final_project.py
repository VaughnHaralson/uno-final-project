...
Original file is located at
    https://colab.research.google.com/drive/1JQ52fc0RB_puA8iADFJa-9oFrEb4d9x6
"""
...
#if computer cannot play it should draw a card until it plays
#once it plays the top card should update from the previous card to the new card
#then it should display the users deck and ask for an input
